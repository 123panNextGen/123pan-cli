...
123pan-cli 是一款基于 Go 开发的高效下载辅助工具，通过模拟安卓客户端协议，帮助用户绕过 123 云盘的自用下载流量限制，实现无阻碍下载体验，并且使用 CLI 界面，体积更小。

## 使用

### 使用打包后的文件运行

如果你的电脑是 Windows 系统或者 Linux 发行版，可以直接下载打包后的文件并运行。
...
>[!TIP]
>Windows 下如果无法运行，可以尝试打开兼容模式。杀毒软件有可能报毒，请放行。
...
首先准备好 [Go](https://go.dev/dl/) 环境，并克隆存储库。
...
- QQ 群: [996241397](https://qm.qq.com/q/GSNgyjINa2)
